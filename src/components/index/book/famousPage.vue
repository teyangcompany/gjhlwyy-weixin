      ...
      <div>
          ...
          <div>
            <li>
              ...
              <div class="cancelIntro">
                <div>
                  <span class="chatDoctor">{{ doctorInfo.docName }}</span> <span
                  class="doctorTitle">{{ doctorInfo.docTitle }}</span>
        ...
        <div v-for="parentItem in deptSchemeList">
          ...
          <div class="list border-1px">
            <p v-if="deptSchemeList.length != 0">{{ parentItem.deptName }}<img
              src="../../../../static/img/book/left-arrow.png" alt=""></p>
          </div>
          <div class="list border-1px" v-if="parentItem.schemeList.length != 0"
               v-for="(item,index) in parentItem.schemeList" @click="book(item,index)">
            <p class="specialBlack">{{ (item.schemeDate).substr(0, 10) }} {{ weekNum[index]
              }} {{ item.schemeAmpm == 'am' ? '上午' : '下午' }}
