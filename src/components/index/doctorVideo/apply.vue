      ...
      <div class="applyInfo">
            ...
            <li>
              ...
              <div class="cancelIntro">
                <div class="introTitle">
                  <span class="subTitle">{{aboutDoctor.docName}}</span>
                  <span class="myDoctor">{{aboutDoctor.docTitle}}</span>
                  <p>{{aboutDoctor.docHosName}}</p>
                  <p>{{aboutDoctor.docDeptName}}</p>
                </div>
              </div>
            </li>
          </ul>
        ...
        <div class="attach">
          <div>
            <section>
              <span>名医视频价格</span>
              <span class="money">价格：¥ {{ aboutDoctor.docFamousConsultPrice }}</span>
            </section>
          </div>
        </div>
        ...
        <div class="applyRule">
          <div class="ruleCenter">
            ...
            <p>2、我们会尽快为您安排专家、视频问诊时间</p>
            <p>3、如果无法成功问诊，我们会为您退款，您也可以主动申请退款</p>
          </div>
        </div>
