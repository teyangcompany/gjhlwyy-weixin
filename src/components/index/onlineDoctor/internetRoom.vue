              ...
              <div class="wrapWhole" >
                <div class="wrapMenu" ref="wrapMenu">
                  <ul>
                    <li class="border-1px allLi" :class="{category_active:clickIndex == index}"
                        ...
                        @click="selectCategoryName(item,index)"> <span>{{ item.gbDeptName }}</span><img v-if="arrow[index] == '1'" src="../../../../static/img/left-arrow.png" alt=""> </li>
                ...
                <div class="wrapContent" ref="wrapContent">
                  <ul>
                    ...
                    <div class="weui-cells weui-cells_radio weuiMargin" >
                      <label class="weui-cell weui-check__label"  v-for="(item,index) in categoryDetail" @click="selectSecond(index,item)">
                        <div class="weui-cell__bd">
                          <p>{{ item.gbDeptName }}</p>
                        </div>
                        <div class="weui-cell__ft">
