  ...
  <div class="success">
    ...
    <div class="successContent" ref="success">
      <div>
        ...
        <p class="doctorInfoTitle">安排信息:</p>
        ...
        <div class="attach">
          <div>
            ...
            <section>
              <span>期望视频问诊时间</span>
              <span class="time">2016/04/07 16:02:13</span>
            </section>
          </div>
        </div>
        <p class="remark">咨询意见:</p>
        <div class="repeat">
          <textarea>烦得很工本费多少个会计法华东师范开个会大开杀戒改好的厚大司考妇姑荷箪食VB年度考试结果番窠倒臼说过话圣诞节快乐挂号能看到设计风格的数控加工</textarea>
        </div>
        <p class="patientInfoTitle">就诊信息:</p>
        <div class="state">
          <p>
        ...
        <div class="patientInfo">
          ...
          <div class="rightMatch">
            <span>老王 男 34岁</span>
            <span>34321432144324324324</span>
            <span>3416536423857</span>
          </div>
        </div>
        <div class="applyNumber">
          <p>申请单编号: 12345678</p>
          <p>创建时间: 2016/08/03 12:05:33</p>
          <p>支付时间: 2016/08/03 12:05:33</p>
          <p>开始时间: 2016/08/03 12:05:33</p>
          <p>结束时间: 2016/08/03 12:05:33</p>
        </div>
      </div>
...
<style scoped lang="scss">
  ...
  .successContent{
    ...
    .state{
      ...
      p{
        margin:0;
        padding:20rem/$rem 20rem/$rem 20rem/$rem 20rem/$rem;
        font-size: 32rem/$rem;
        color: #666666;
      }
      >div{
