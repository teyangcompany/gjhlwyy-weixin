<template>
  <div class="chat">
    <v-header :title="title" :rightTitle="goingTitle" :waitImg="waitImg"
              v-if="aboutConsult.consultStatus == 'NEEDPAY' && aboutConsult.consultTypeName == '图文咨询' && aboutReplyMessage.length == 0"
              @on-cancel="goCancel"></v-header>
    <v-header :title="title" :rightTitle="goingTitle" :waitImg="waitImg"
              v-else-if="aboutConsult.consultStatus == 'GOING'&& aboutConsult.consultTypeName == '全科分诊' && aboutReplyMessage.length == 0"
              @on-cancel="goAllCancel"></v-header>
    <v-header :title="title" :rightTitle="overConsultTitle" :waitImg="waitImg"
              v-else-if="aboutConsult.consultStatus == 'GOING'&& aboutConsult.consultTypeName == '图文咨询' && aboutReplyMessage.length != 0"
              @on-cancel="goOverConsult"></v-header>
        ...
        <ul v-if="aboutConsult != ''">
          <li ref="chatLi">
            <div class=" other mysay">
              ...
              <img v-if="aboutConsult.consulterGender == 'F' && !(aboutConsult.patAvatar)"
                   src="../../../../static/img/pat.f.jpg" alt="">
              <img v-if="aboutConsult.consulterGender == 'M' && !(aboutConsult.patAvatar)"
                   src="../../../../static/img/pat.m.jpg" alt="">
              <div class="whatsay">
        ...
        <ul>
          <li v-for="item in aboutReplyMessage" ref="chatLi">
            <div class="other" :class="{mysay:item.replierType == 'PAT'}">
              <img :src="consultPatAva(aboutConsult)" alt="" v-if="item.replierType == 'PAT'">
    ...
    <footer v-if="aboutConsult.consultStatus == 'NEEDPAY'&& aboutReplyMessage && aboutReplyMessage.length == 0"
            class="payButton">
      <div class="payWrap">
        <button @click="pay()">付款</button>
      </div>
    </footer>
    <footer v-else-if="aboutConsult.consultStatus == 'GOING' && aboutReplyMessage && aboutReplyMessage.length == 0"
            class="payButton">
    ...
    <footer :class="{footshow:seeMore}" ref="footer"
            v-else-if="aboutConsult.consultStatus == 'GOING' && aboutReplyMessage.length != 0">
