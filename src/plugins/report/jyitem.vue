<template>
  <div class="jyitem">
    <h6 @click="open" class="fs14"><font class="iconfont" v-if="!o.open">&#xe6b7;</font><font v-else class="iconfont">&#xe72c;</font>{{o.zUHEXMMC}}
    </h6>
    <div class="table" v-if="o.open">
      <table>
        <thead>
        <th width="40">NO.</th>
        <th>项目/单位</th>
        ...
        <tr v-for="(oo,ii) in o.list">
          ...
          <td>
            <p class="p3 right">{{oo.tIJIANJG}} <span v-if="oo.yICHANGTS==0">↓</span><span
        ...
        <tr>
          <td colspan="3" class="info">
            ...
            <ul class="flex">
              ...
              <li>
                <label>报告日期：</label>{{o.sHENHERQ|splitTime}}
              </li>
            </ul>
          </td>
        </tr>
